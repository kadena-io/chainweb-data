...
~chainweb-data~ requires [[https://www.postgresql.org/][Postgres]] and [[https://nixos.org/download.html][Nix]] to be installed.

* Building 

#+begin_example

wget https://github.com/kadena-io/chainweb-data
cd chainweb-data
nix-build
#+end_example
